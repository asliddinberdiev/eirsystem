...
export const useMailStore = defineStore(
  ...
  () => {
    ...
    // Mock data (migrated from server/api/mails.ts)
...
Emergency: (555) 987-6544`,
    ...
    async function fetchMails() {
      ...
      try {
        ...
        // const data = await $fetch('/api/mails')
        mails.value = mockMails;
      } catch (e) {
        error.value = e instanceof Error ? e.message : "Failed to fetch mails";
